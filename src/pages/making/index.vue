<template>
    ...
    <section class="sec-2">
        ...
        <ul>
            ...
            <li>📖 <router-link to="/making/input-axis-rpg-walk-printing-shift-boundary-1" :style="getPreviousLinkHighlight('/making/input-axis-rpg-walk-printing-shift-boundary-1')">■テスト：　上下左右に移動しようぜ！　フェース・シフト</router-link></li>

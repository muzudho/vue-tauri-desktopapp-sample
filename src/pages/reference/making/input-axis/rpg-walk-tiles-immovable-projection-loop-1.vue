<template>
    ...
    <h2><span class="parent-header">ＲＰＧの歩行グラフィック　＞　</span>不動タイルへ投影・両端つながりの像</h2>
    <section class="sec-2">
        <br/>
    ...
    <br/>
    <h3><span class="parent-header-lights-out">ＲＰＧの歩行グラフィック　＞　</span><span class="parent-header">不動タイルへ投影・両端つながりの像　＞　</span>ソースコード</h3>
    <section class="sec-3">
        <source-link
            pagePath="/reference/making/input-axis/rpg-walk-tiles-immovable-projection-loop-1"/>
    </section>
</template>

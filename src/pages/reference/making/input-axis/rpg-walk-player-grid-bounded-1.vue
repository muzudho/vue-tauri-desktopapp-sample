<template>
    ...
    <h5><span class="parent-header">ＲＰＧの歩行グラフィック　＞　</span>自機ウォーキング・境界のあるグリッド吸着</h5>
    <section class="sec-5">
        <br/>
    ...
    <br/>
    <h6><span class="parent-header-lights-out">ＲＰＧの歩行グラフィック　＞　</span><span class="parent-header">自機ウォーキング・境界のあるグリッド吸着　＞　</span>ソースコード</h6>
    <section class="sec-6">
        <source-link

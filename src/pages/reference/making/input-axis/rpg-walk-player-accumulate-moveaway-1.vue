<template>
    ...
    <h2>ＲＰＧの歩行グラフィック　＞　自機ウォーキング・遠ざかる累積</h2>
    <section class="sec-2">
        <br/>
    ...
    <br/>
    <h3><span class="parent-header-lights-out">ＲＰＧの歩行グラフィック　＞　</span><span class="parent-header">自機ウォーキング・遠ざかる累積</span>　＞　ソースコード</h3>
    <section class="sec-3">
        <source-link
...
<script setup lang="ts">
    ...
    const board1Style = computed<CompatibleStyleValue>(()=>{ // ボードとマスクを含んでいる領域のスタイル
        return {
            width: `${3 * tileBoard1TileWidth}px`,
            height: `${3 * tileBoard1TileHeight}px`,
            zoom: appZoom.value,
        };
    });

<template>
    ...
    <h5><span class="parent-header">ＲＰＧの歩行グラフィック　＞　</span>回り込むタイルへ投影・両端つながりの像・視野外マスク例示</h5>
    <section class="sec-5">
        <br/>
    ...
    <br/>
    <h6><span class="parent-header-lights-out">ＲＰＧの歩行グラフィック　＞　</span><span class="parent-header">回り込むタイルへ投影・両端つながりの像・視野外マスク例示　＞　</span>ソースコード</h6>
    <section class="sec-6">
        <source-link

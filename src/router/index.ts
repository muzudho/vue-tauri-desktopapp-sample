...
const routes = [
    ...
    {
        name: 'Reference_Making_GameMachineTest1',
        path: '/reference/making/game-machine-test-1',
        component: () => import('../pages/reference/making/game-machine-test-1.vue'),
    },
    {
        name: 'Reference_Making_GameMachineTest2',
        path: '/reference/making/game-machine-test-2',
        component: () => import('../pages/reference/making/game-machine-test-2.vue'),
    },
    {
